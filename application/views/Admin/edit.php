...
<div class="layui-tab layui-tab-card admin_bg">
  ...
  <div class="layui-tab-content" >
    <div class="layui-tab-item layui-show">
		...
		<!--内容部分开始-->
			<form class="form-horizontal" method = "post" action = "<?php echo site_url('Article/updateart');?>/<?php echo $article['id']; ?>">
				<div class="form-group">
					...
					<div class="col-sm-4">
						<select name="category" style="width:90px;height:30px;">
							...
							<option value="<?php echo $val['cid']?>" <?php if($val['cid'] == $article['cid']){ echo "selected='selected'";}?>><?php echo $val['catename'];?></option>
							<?php } ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea class="form-control" rows="2" name = "description"><?php echo $article['description']; ?></textarea>
					</div>
				</div>
				<div class="form-group">
